...
export const INITIAL_KNOWLEDGE_GAPS: KnowledgeGapItem[] = [
  {
    id: 'gap-01',
    topicEn: 'How do I request Application X access?',
    topicAr: 'كيف أطلب الصلاحيات للوصول إلى التطبيق X؟',
    sourceApp: 'Jira',
    repeatedQuestionsCount: 145,
    signals: ['Multiple fragmented docs', 'No single authoritative source', 'High SME dependency'],
    smeDependency: 'High',
    recommendedActionEn: 'Create authoritative Confluence SOP & FAQ article',
    recommendedActionAr: 'إنشاء دليل إجراءات عمل معتمد (SOP) و FAQ موحد في Confluence',
    priority: 'High',
    status: 'Open'
  },
  {
    id: 'gap-02',
    topicEn: 'Vendor Onboarding Process for Cloud Services',
    topicAr: 'عملية اعتماد الموردين الجدد للخدمات السحابية',
    sourceApp: 'Teams',
    repeatedQuestionsCount: 98,
    signals: ['Frequent private chat requests', 'No step-by-step checklist in SharePoint', 'High escalation rate'],
    smeDependency: 'High',
    recommendedActionEn: 'Generate self-service step-by-step checklist & SharePoint template',
    recommendedActionAr: 'توليد قائمة مراجعة تفاعلية ذاتية ونموذج موحد في SharePoint',
    priority: 'High',
    status: 'Open'
  },
  {
    id: 'gap-03',
    topicEn: 'Microservices Deployment SLA & Rollback Guidelines',
    topicAr: 'معايير اتفاقية مستوى الخدمة لنشر الخدمات المصغرة وإجراءات الاسترجاع',
    sourceApp: 'Confluence',
    repeatedQuestionsCount: 67,
    signals: ['Outdated 2023 documentation', 'Conflicting advice across squads', 'High release delay risk'],
    smeDependency: 'Medium',
    recommendedActionEn: 'Refresh Confluence architecture blueprint with automated CI/CD safeguards',
    recommendedActionAr: 'تحديث المخطط المعماري في Confluence وتضمين حواجز الأمان لخطوط الإنتاج',
    priority: 'Medium',
    status: 'Open'
  }
];
